...
class IoTWatchView extends WatchUi.View {
    ...
    function sensor1() {
        ...
        Communications.makeWebRequest("https://demo.iottalk.tw/watch_dashboard/watch-xAcc-i", {"data" => [xAccel.toNumber()]}, options, method(:onReceive1));
    }
    ...
    function sensor2() {
        ...
        Communications.makeWebRequest("https://demo.iottalk.tw/watch_dashboard/watch-yAcc-i", {"data" => [yAccel.toNumber()]}, options, method(:onReceive2));
    }
    ...
    function sensor3() {
        ...
        Communications.makeWebRequest("https://demo.iottalk.tw/watch_dashboard/watch-hR-i", {"data" => [hR.toNumber()]}, options, method(:onReceive3));
    }
    ...
    function sensor4() {
        ...
        Communications.makeWebRequest("https://demo.iottalk.tw/watch_dashboard/watch-altitude-i", {"data" => [altitude.toFloat()]}, options, method(:onReceive4));
    }
    ...
    function sensor5() {
        ...
        Communications.makeWebRequest("https://demo.iottalk.tw/watch_dashboard/watch-cadence-i", {"data" => [cadence.toNumber()]}, options, method(:onReceive5));
    }
    ...
    function sensor6() {
        ...
        Communications.makeWebRequest("https://demo.iottalk.tw/watch_dashboard/watch-heading-i", {"data" => [heading.toFloat()]}, options, method(:onReceive6));
    }
    ...
    function sensor7() {
        ...
        Communications.makeWebRequest("https://demo.iottalk.tw/watch_dashboard/watch-xMag-i", {"data" => [xMag.toNumber()]}, options, method(:onReceive7));
    }
    ...
    function sensor8() {
        ...
        Communications.makeWebRequest("https://demo.iottalk.tw/watch_dashboard/watch-yMag-i", {"data" => [yMag.toNumber()]}, options, method(:onReceive8));
    }
    ...
    function sensor9() {
        ...
        Communications.makeWebRequest("https://demo.iottalk.tw/watch_dashboard/watch-zMag-i", {"data" => [zMag.toNumber()]}, options, method(:onReceive9));
    }
    ...
    function sensor10() {
        ...
        Communications.makeWebRequest("https://demo.iottalk.tw/watch_dashboard/watch-power-i", {"data" => [power.toNumber()]}, options, method(:onReceive10));
    }
    ...
    function sensor11() {
        ...
        Communications.makeWebRequest("https://demo.iottalk.tw/watch_dashboard/watch-pressure-i", {"data" => [pressure.toFloat()]}, options, method(:onReceive11));
    }
    ...
    function sensor12() {
        ...
        Communications.makeWebRequest("https://demo.iottalk.tw/watch_dashboard/watch-speed-i", {"data" => [speed.toFloat()]}, options, method(:onReceive12));
    }
    ...
    function sensor13() {
        ...
        Communications.makeWebRequest("https://demo.iottalk.tw/watch_dashboard/watch-temp-i", {"data" => [temp.toNumber()]}, options, method(:onReceive13));
    }
    ...
    function sensor14() {
        ...
        Communications.makeWebRequest("https://demo.iottalk.tw/watch_dashboard/watch-lat-i", {"data" => [latitude.toFloat()]}, options, method(:onReceive14));
    }
    ...
    function sensor15() {
        ...
        Communications.makeWebRequest("https://demo.iottalk.tw/watch_dashboard/watch-long-i", {"data" => [longitude.toFloat()]}, options, method(:onReceive15));
    }
